...
const Addpet = () => {
    ...
    const handleAddpetForm = async (e) => {
        ...
        if (data.success) {
            ...
            const res = await axiosSecure.post(`/add-pet?email=${user.email}`, addData); // Send POST request
    ...
    return (
        <div >
            ...
            <h1 className='text-4xl text-center dark:text-white'>Add a pet</h1>
            <div>
